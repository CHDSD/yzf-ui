    ...
    var Modal = function () {
        ...
        _createClass(Modal, [{
            ...
            value: function config(_config4) {
                this._config = $.extends({}, this._config, _config4);
            }
        }, {
            key: 'hide',
            value: function hide() {
...
(function ($, window, document, undefined) {
    ...
    var YZFPagination = function YZFPagination(element, options) {
    ...
    YZFPagination.prototype = {
        ...
        getPages_v_1_1: function getPages_v_1_1(currentPage) {
            var pages = [];
        ...
        render: function render(pages) {
            ...
            this.$listContainer.find('.next').toggleClass('disabled', pages.currentPage === this.options.totalPages).data('page', next < this.options.totalPages ? next : this.options.totalPages);
        },
        ...
        equals: function equals(oldArray, newArray) {
            var i = 0;
